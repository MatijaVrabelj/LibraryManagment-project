      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={6}>
          <div className="shadow p-2">
            <h1 className="text-secondary text-xl font-hold uppercase"> Books</h1>
            <hr />
        ...
        <Col span={6}>
          <div className="shadow p-2">
            ...
            <div className="flex justify-between mt-1">
              <h1 className="text-md"> Collected Rent</h1>
              <h1> {reports?.revenue?.rentCollected}  </h1>
            </div>

            <div className="flex justify-between mt-1">
              <h1 className="text-md"> Collected fine</h1>
              <h1> {reports?.revenue?.fineCollected}  </h1>
            </div>

            <div className="flex justify-between mt-1">
              <h1 className="text-md">Pending Rent</h1>
